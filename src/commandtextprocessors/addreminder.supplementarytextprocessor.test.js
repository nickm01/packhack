...
describe('add reminder supplementary text processor', () => {
  ...
  describe('New York Timezone 8pm', () => {
    ...
    it('✅ today to go shopping', () => { shouldMatch('today to go shopping', {dateGMT: 'Sun Jan 01 2017 05:00:00', dateText: 'Sunday, Jan 1st', title: 'go shopping'}) })
    ...
    it('✅ to go shopping tomorrow', () => { shouldMatch('to go shopping tomorrow', {dateGMT: 'Mon Jan 02 2017 05:00:00', dateText: 'Monday, Jan 2nd', title: 'go shopping'}) })
